...
from apps.engagement.schemas import ApiResponse, ReportListResponse, ReportResponse
...
def test_post_report_success():
    ...
    with patch("apps.engagement.routes.create_report_service", AsyncMock(return_value=mock_response)) as create_svc:
...
def test_get_reports_admin_success():
    ...
    with patch("apps.administration.routes.list_reports_admin_service", AsyncMock(return_value=mock_response)) as list_svc:
...
def test_get_report_details_admin_success():
    ...
    with patch("apps.administration.routes.get_report_details_admin_service", AsyncMock(return_value=mock_response)) as detail_svc:
...
def test_review_report_admin_success():
    ...
    with patch("apps.administration.routes.review_report_admin_service", AsyncMock(return_value=mock_response)) as review_svc:
